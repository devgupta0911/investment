...
builder.Services.AddTransient<IAdvisorRegistrationService, AdvisorRegistrationService>();
builder.Services.AddTransient<IAdvisorRegistrationRepository, AdvisorRegistrationRepository>();
